...
<head>
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'BlogLanguage'); ?>" content="<?php echo __('Search'); ?> - <?php if (isset($_search)) { echo sprintf(__('%1$s'),context::global_filters($_search,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
...
<?php while ($_ctx->posts->fetch()) : ?>
  ...
  'strip_tags' => 0,
	...
	<?php if ($_ctx->posts->firstPostOfDay()) : ?>
		<div class="day-date">
			<span class="date_month"><?php echo context::global_filters($_ctx->posts->getDate('%b',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'format' => '%b',
			...
			<span class="date_day"><?php echo context::global_filters($_ctx->posts->getDate('%e',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
